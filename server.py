    ...
    try:
        ...
        if len(APPS) > 0:
            ...
            bot.edit_message_text(text="**📱 Apk Downloader Premium**\n\n__Step 2 of  2__\n"
                              "\n\n🔍 Search for **{}** Returned (`{}`) results\n\n Click on your app and i will download it right away".format(search_query, num), chat_id=update.from_user.id, reply_markup=reply_markup, message_id=sent.message_id, disable_web_page_preview=True)
        else:
            sent.edit("**📱 Apk Downloader Premium**\n\n__Step 1 of  2__\n"
                              "\n\n❗️ Search for **{}** Returned (`0`) results\n\n You may try again by entering an altenative search and i will find it for you".format(search_query))
            return
